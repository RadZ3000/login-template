...
const Home: NextPage = () => {
  return (
    <div className="flex flex-column justify-center h-screen min-w-full">
      ...
      <div className="grid gap-y-4 justify-center content-center text-center bg-slate-900 text-white w-3/5">
        ...
        <button className="bg-slate-400 text-black py-2 rounded-lg hover:text-white">Login with Email</button>
        <div className="flex justify-center items-center">
          <span className="w-full border border-white"></span>
          <span className="px-4">Or</span>
          <span className="w-full border border-white"></span>
        </div>
        <button className="flex items-center gap-x-36 bg-transparent text-white border-2 rounded-lg border-white py-2 px-4 hover:text-red-300 hover:border-red-300">
