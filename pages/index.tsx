  ...
  return (
    <div className="flex flex-col sm:flex-row justify-center h-screen md:h-max lg:h-screen w-screen bg-slate-900">
      ...
      <div className="grid gap-y-4 justify-center content-center text-center bg-slate-900 text-white lg:w-3/5">
        ...
        <h3 className="mt-36">Built by <a href="https://heraldadowei.com" target="_blank" rel="noopener noreferrer" className="underline hover:text-red-300">Herald Adowei</a></h3>
